"""The main MATRIX class that represents an Omicron MATRIX file.
"""
...
class OMICRONmatrix:
    """This is the main class that represents an Omicron MATRIX file
    
    Args:
        filepath: the name of the .*_mtrx file to be opened
    """

    def __init__(self,
                 filepath):
        """Load data and metadata relative to the given .*_mtrx file
        
        Args:
                filepath: path to the .*_mtrx file.
    ...
    def _loadMeta(self):
        """Load metadata from .*_mtrx file into a dictionary
        
        Returns: dictionary of metadata
        
        """

        # Open .*_mtrx file and load content
    ...
    def _loadData(self):
        """Load data from .*_mtrx file into a numpy array
